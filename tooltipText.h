...
#ifndef SRC_TOOLTIPTEXT_H_
#define SRC_TOOLTIPTEXT_H_
...
class tooltipText: public gGUIControl {
public:
	...
	void tooltipActivate(gGUISizer* sizer, objects guiobject, int lineNo, int columnNo, std::string text);
